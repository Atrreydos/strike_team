...
public class EvenеtVotingTestData {
    public static final int EVENT_VOTING_1_ID = 1;
    public static final int EVENT_VOTING_2_ID = 2;

    public static final EventVoting EVENT_VOTING_1 = new EventVoting(EVENT_VOTING_1_ID, EVENT_1);
    public static final EventVoting EVENT_VOTING_2 = new EventVoting(EVENT_VOTING_2_ID, EVENT_2);

...
public class UserTestData {
    ...
    public static final User USER_1 = new User(USER1_ID, "User1", "user1_login", "password", true, Role.ROLE_USER);
    public static final User ADMIN_1 = new User(ADMIN1_ID, "Admin1", "admin1_login", "password", true, Role.ROLE_USER, Role.ROLE_ADMIN);

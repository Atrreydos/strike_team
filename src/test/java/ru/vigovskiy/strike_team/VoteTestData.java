...
public class VoteTestData {
    ...
    public static final Vote VOTE_1 = new Vote(VOTE1_ID, LocalDate.of(2018, 10, 30), DecisionType.ACCEPT, USER_1);
    public static final Vote VOTE_2 = new Vote(VOTE2_ID, LocalDate.of(2018, 10, 29), DecisionType.ACCEPT, ADMIN_1);
    public static final Vote VOTE_3 = new Vote(VOTE3_ID, LocalDate.of(2018, 10, 31), DecisionType.REJECT, ADMIN_1);
